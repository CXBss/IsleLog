    ...
    return ListView(
      ...
      children: [
        ...
        StatsOverviewCard(
          ...
          articleTotalWords: data.articleTotalWords,
        ),
        const SizedBox(height: 24),

        // ── 热力图 ────────────────────────────────────────────────
        _SectionTitle(title: '近 365 天日记字数'),
            ...
            child: HeatmapWidget(
              ...
              onDayTap: (date) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text('${date.month}月${date.day}日  $words 字'),
