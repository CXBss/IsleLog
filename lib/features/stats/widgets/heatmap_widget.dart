...
/// GitHub 风格热力图，展示过去 365 天每天的日记字数
///
...
class HeatmapWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final weekdayOffset = startDay.weekday - 1;
  ...
  Widget _buildCell(
    ...
    final color =
        inRange ? _colorForCount(words, maxWords) : Colors.transparent;
    ...
    return Positioned(
      ...
      child: GestureDetector(
        ...
        child: Tooltip(
          message: inRange ? '${date.month}/${date.day}  $words 字' : '',
          child: Container(
            width: cellSize,
            height: cellSize,
            decoration: BoxDecoration(
